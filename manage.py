...
# web application at http://createuz.pythonanywhere.com/
...
#     start_response(status, response_headers)user/createuz/consoles/29429928/
...
#import sys
#
#path = '/home/createuz/path/to/my/app
...
import sys
#
## assuming your django settings file is at '/home/createuz/mysite/mysite/settings.py'
## and your manage.py is is at '/home/createuz/mysite/manage.py'
path = '/home/createuz/Portfolio'
if path not in sys.path:
    sys.path.append(path)
#
...
#import sys
#
## The "/home/createuz" below specifies your home
## directory -- the rest should be the directory you uploaded your Flask
## code to underneath the home directory.  So if you just ran
## "git clone git@github.com/myusername/myproject.git"
## ...or uploaded files to the directory "myproject", then you should
## specify "/home/createuz/myproject"
#path = '/home/createuz/path/to/flask_app_directory'
#if path not in sys.path:
#    sys.path.append(path)
#
